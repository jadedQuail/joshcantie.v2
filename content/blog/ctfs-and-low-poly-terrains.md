...
This weekend I had the pleasure of playing OpenSOC, a DFIR challenge hosted by [Recon InfoSec](https://reconinfosec.com/), where teams hunt down various threats and "capture flags." I got the opportunity to become more familiar with a bunch of great tools, such as [Graylog](https://www.graylog.org/), a log management software, and [Kibana](https://www.elastic.co/products/kibana), a data visualization tool.
...
I really enjoyed this CTF-esque event, so I'm going to try a few more. I found a great website called [OverTheWire](https://overthewire.org/wargames/) that has a lot of great "Wargames" that allow you to practice security concepts. I recently started the first one, called "Bandit," which teaches you how to use tools and commands on Linux machines. So far, it's been pretty fun!
...
![Lowpolyterr](/images/lowpolyterr.PNG)
