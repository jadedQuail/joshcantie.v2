...
![As the player drops into the next segment, another segment spawns. A maximum of 3 segments can exist at a time, so older segments are despawned.](/images/level_generation.gif)

*As the player drops into the next segment, another segment spawns. A maximum of 3 segments can exist at a time, so older segments are despawned.*
